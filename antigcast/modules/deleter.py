...
@Bot.on_message(filters.command("unbl") & ~filters.private & Admin)
...
async def deletermessag(app : Bot, message : Message):
    text = f"Maaf, Grup ini tidak terdaftar di dalam list. Silahkan hubungi @Usern4meDoesNotExist404 Untuk mendaftarkan Group Anda.**"
